...
For production examples: [OpenSecret](https://opensecret.cloud/) used [PlanetScale's migration scripts](https://github.com/planetscale/migration-scripts) based on [their migration guide](https://planetscale.com/docs/postgres/imports/neon) for their migration. You can read their [blog post](https://blog.opensecret.cloud/why-we-migrated-from-neon-to-planetscale/) about it. This guide follows the same documentation, with the scripts available as automation options.
