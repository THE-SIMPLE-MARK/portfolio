...
Due to not being able to hook up Apple Watches series 7, and newer to your Mac via a cable, due to the lack of the diagnostic port (and due to the lack of commercial availability of [the wireless radio dock they've replaced the debug port for series 7+](https://www.macrumors.com/2021/10/15/apple-watch-series-7-internal-dock-images/)), you're forced to rely on WiFi / Bluetooth.
